        ...
        <div className="p-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {composition.map((item, index) => (
                                            <tr key={index}>
                                                <td className="px-4 py-2 text-sm text-gray-700">{item.ingredient}</td>
                                                <td className="px-4 py-2 text-sm text-gray-500 text-right">{item.amount}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                    <h3 className="text-sm font-bold text-brand-dark mb-3 uppercase tracking-wide border-b pb-2">Datos del Paciente</h3>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                    <h3 className="text-sm font-bold text-brand-dark mb-3 uppercase tracking-wide border-b pb-2">Datos del Médico</h3>
                    <div className="space-y-4">
                        <div>
